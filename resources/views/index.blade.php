...
@section('content')
            ...
            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4">
                                    <div class="single-about-box">
                                        <div class="icon-box-outer bg-ex">
                                            <div class="icon-box">
                                                <img src="{{ asset('img/expierence.svg') }}" alt="#">
                                            </div>
                                        </div>
                                        <h3>Expierence</h3>
                ...
                <div class="col-lg-5">
                    <div class="about-right">
                        <div class="video-box">
                            <img src="{{ asset('img/about-bg.jpg') }}" alt="#">
                            <div class="icon-box">
                ...
                <div class="choose-section-carousel">
                    ...
                    <div class="col">
                        <div class="single-item">
                            <div class="icon-box">
                                <img src="{{ asset('img/daily-income.svg') }}" alt="#">
                            </div>
                            <div class="text-box">
                    ...
                    <div class="col">
                        <div class="single-item">
                            <div class="icon-box">
                                <img src="{{ asset('img/withdraw1.svg') }}" alt="#">
                            </div>
                            <div class="text-box">
                    ...
                    <div class="col">
                        <div class="single-item">
                            <div class="icon-box">
                                <img src="{{ asset('img/invest-fild.svg') }}" alt="#">
                            </div>
                            <div class="text-box">
                    ...
                    <div class="col">
                        <div class="single-item">
                            <div class="icon-box">
                                <img src="{{ asset('img/customer-service.svg') }}" alt="#">
                            </div>
                            <div class="text-box">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-4 text-center reunir-content-center">
                        <div class="single-box location-left">
                            <div class="img-box">
                                <div class="font-side">
                                    <img src="{{ asset('img/sign-up.svg') }}" alt="#">
                                </div>
                                <div class="back-side">
                                    <img src="{{ asset('img/sign-up.svg') }}" alt="#">
                                </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 text-center reunir-content-center">
                        <div class="single-box">
                            <div class="img-box">
                                <div class="font-side">
                                    <img src="{{ asset('img/deposit.svg') }}" alt="#">
                                </div>
                                <div class="back-side">
                                    <img src="{{ asset('img/deposit.svg') }}" alt="#">
                                </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 text-center reunir-content-center">
                        <div class="single-box location-right">
                            <div class="img-box">
                                <div class="font-side">
                                    <img src="{{ asset('img/withdraw-1.svg') }}" alt="#">
                                </div>
                                <div class="back-side">
                                    <img src="{{ asset('img/withdraw-1.svg') }}" alt="#">
                                </div>
                        ...
                        <div class="investment-section-carousel">
                            ...
                            <div class="col text-center">
                                <div class="single-item">
                                    <div class="single-image">
                                        <img src="{{ asset('img/deposit-bg.jpg') }}" alt="#">
                                    </div>
                                    <div class="icon-box">
                                        <img src="{{ asset('img/deposit1.svg') }}" alt="#">
                                    </div>
                            ...
                            <div class="col text-center">
                                <div class="single-item">
                                    ...
                                    <div class="icon-box">
                                        <img src="{{ asset('img/deposit2.svg') }}" alt="#">
                                    </div>
                                    <div class="part-prize">
                            ...
                            <div class="col text-center">
                                <div class="single-item">
                                    ...
                                    <div class="icon-box">
                                        <img src="{{ asset('img/deposit3.svg') }}" alt="#">
                                    </div>
                                    <div class="part-prize">
                            ...
                            <div class="col text-center">
                                <div class="single-item">
                                    ...
                                    <div class="icon-box">
                                        <img src="{{ asset('img/deposit4.svg') }}" alt="#">
                                    </div>
                                    <div class="part-prize">
                                        <span class="percentage"><b>8</b>%</span>
                                        <h3>Daily For Even</h3>
            ...
            <div class="row referral-section-item">
                <div class="col-lg-2 col-md-2 col-sm-2">
                    <div class="referral-img">
                        <img src="{{ asset('img/referral-img.png') }}" alt="#">
                    </div>
                </div>
                <div class="col-lg-10 col-md-10 col-sm-10">
                            ...
                            <div class="payment-methods-outer">
                                <div class="payment-methods">
                                    <div class="icon-gallery">
                                        <div class="icon-box">
                                            <div class="icon-img">
                                                <img src="{{ asset('img/card-icon.png') }}" alt="#">
                                            </div>
                                    ...
                                    <div class="icon-gallery">
                                        <div class="icon-box">
                                            <div class="icon-img">
                                                <img src="{{ asset('img/litecoin.png') }}" alt="#">
                                            </div>
                                        ...
                                        <div class="icon-box">
                                            <div class="icon-img">
                                                <img src="{{ asset('img/ripple.png') }}" alt="#">
                                            </div>
    ...
    <section class="transaction-section">
        <div class="right-img">
            <img class="right-ellipse1" src="{{ asset('img/transaction-bg-ellipse-01.png') }}" alt="#">
            <img class="right-shape1" src="{{ asset('img/transaction-bg-shape-01.png') }}" alt="#">
            <img class="right-shape2" src="{{ asset('img/transaction-bg-shape-01.png') }}" alt="#">
            <img class="right-ellipse2" src="{{ asset('img/transaction-bg-ellipse-02.png') }}" alt="#">
        </div>
        <div class="left-img">
            <img class="left-ellipse1" src="{{ asset('img/transaction-bg-ellipse-03.png') }}" alt="#">
            <img class="left-ellipse2" src="{{ asset('img/transaction-bg-ellipse-03.png') }}" alt="#">
            <img class="left-ellipse3" src="{{ asset('img/transaction-bg-ellipse-03.png') }}" alt="#">
            <img class="left-shape1" src="{{ asset('img/transaction-bg-shape-01.png') }}" alt="#">
            <img class="left-shape2" src="{{ asset('img/transaction-bg-shape-01.png') }}" alt="#">
            <img class="left-shape3" src="{{ asset('img/transaction-bg-shape-01.png') }}" alt="#">
            <img class="left-shape4" src="{{ asset('img/transaction-bg-shape-01.png') }}" alt="#">
        </div>
        <div class="container">
            <div class="row d-flex justify-content-center">
                <div class="col-lg-8">
                            ...
                            <table class="table table-responsive transaction-table">
                                ...
                                <tr>
                                    <th scope="row" class="d-flex">
                                        <div class="user-img">
                                            <img src="{{ asset('img/table-img1.png') }}" alt="#">
                                        </div>
                                        <span>Jim Adams</span>
                                    </th>
                                    <td>$10.50</td>
                                ...
                                <tr>
                                    <th scope="row" class="d-flex">
                                        <div class="user-img">
                                            <img src="{{ asset('img/table-img2.png') }}" alt="#">
                                        </div>
                                ...
                                <tr>
                                    <th scope="row" class="d-flex">
                                        <div class="user-img">
                                            <img src="{{ asset('img/table-img3.png') }}" alt="#">
                                        </div>
                                        <span>Kim Mccoy</span>
                                    </th>
                                    <td>$10.50</td>
                                ...
                                <tr>
                                    <th scope="row" class="d-flex">
                                        <div class="user-img">
                                            <img src="{{ asset('img/table-img4.png') }}" alt="#">
                                        </div>
                                ...
                                <tr>
                                    <th scope="row" class="d-flex">
                                        <div class="user-img">
                                            <img src="{{ asset('img/table-img5.png') }}" alt="#">
                                        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-5 col-md-5">
                    <div class="right-area">
                        <img class="ellipse-01" src="{{ asset('img/download-bg-ellipse-01.png') }}" alt="#">
                        <img class="ellipse-02" src="{{ asset('img/download-bg-ellipse-02.png') }}" alt="#">
                        <img class="ellipse-03" src="{{ asset('img/download-bg-ellipse-03.png') }}" alt="#">
                        <img class="ellipse-04" src="{{ asset('img/download-bg-ellipse-04.png') }}" alt="#">
                        <img class="smart-phone" src="{{ asset('img/download-smart-phone.png') }}" alt="#">
                    </div>
                </div>
            </div>
        </div>
